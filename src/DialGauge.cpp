...
void DialGauge::createFrameBuffer() {
...
void DialGauge::createDial(const unsigned short *gaugeImage) {
...
void DialGauge::updateGauge(float value) {
    ...
    frameBuffer->drawFloat(value, 1, 120, 220, 7); // insert the text
